...
const SingleChefCard = ({ chef }) => {
    return (
        <div className='border relative group overflow-hidden bg-blue-200 duration-500 hover:bg-my_primary group border rounded-lg'>

            <img className='max-h-96 group-hover:scale-150 duration-500 group-hover:pt-12' src={chef.picture} alt="" />
            <div className='bg-white absolute h-14 duration-500 group-hover:h-1/2 w-full bottom-0 rounded-t-3xl flex flex-col items-center p-5 '>
