...
const OurChefs = () => {
    ...
    console.log('chef data from ourChefs', chefsData)
    return (
        <div className='my-container bg-[#efefef] '>
            <h3 className='text-center text-3xl   font-extrabold text-gray-600 '>Our Master Chefs </h3>
            <p className='text-center  mb-12 mt-2'>Each of our chefs has 4+ experience. They make recipes with their love</p>
