    ...
    return (
        <div className='my-container bg-white'>
            ...
            <div className=' '>
                ...
                <p className='font-md mt-2 '>
                    custom hook is special function provided by rect it's allow to share data or functionality with multiple components. by using this we create reusable component, it's easer to understand and improve code readiblity
                </p>
            </div>
        </div>
    );
